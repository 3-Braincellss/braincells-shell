...
We transform user given data into formatted string list using a lark transformer,
which give us a lot of flexibility in comparison to the default RegexLexer recommended
by `prompt_toolkit`.
"""
